package com.thank.cuttlefish.wechat.enums;


import com.thank.cuttlefish.common.utils.ResultStatus;

public enum CuttlefishWechatResultStatus implements ResultStatus {
    ...
    CuttlefishWechatResultStatus(String code, String msg) {
        this.code = code;
        this.msg = msg;
    }
